...
const Home = __webpack_require__(14).default;
const { renderToString, renderToStaticMarkup } = __webpack_require__(15);

module.exports = ({ title }) => {
  const html = renderToString(React.createElement(Home, { initCount: 5 }));
  ...
  return renderToStaticMarkup(React.createElement(
    ...
    React.createElement(
      'body',
      null,
      React.createElement('div', { id: 'app', dangerouslySetInnerHTML: { __html: html } })
    ),
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Home;
